...
@section('title', 'Request Withdraw Approve')
@section('page_title', 'Request Withdraw Approve')
                    ...
                    <div class="panel panel-bordered panel-info border border-info">
                        ...
                        <div class="p-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="p-5">
                                        <form action="{{ route("user_new_withdraw_accept",["id"=>$userWithdrawHistory->id]) }}" method="POST" id="exampleFullForm" autocomplete="off">
                                            @csrf
                                                ...
                                                <div class="col-xl-4 form-horizontal">
                                                    <div class="form-group">
                                                        <div class="input-group input-group-icon">
                                                            ...
                                                            <input type="text" name="reference" class="form-control" placeholder="reference number" value="{{ old("reference") }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
