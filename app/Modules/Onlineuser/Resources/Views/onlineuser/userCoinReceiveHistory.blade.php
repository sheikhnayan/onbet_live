...
@section('title', 'Coin receive record')
@section('page_title', 'Coin receive record')
                ...
                <div class="col-md-12">
                    <div class="panel panel-bordered panel-info border border-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">@yield('page_title') <b class="text-dark">Total Coin receive {{ $totalCoinReceive }}</b></h3>
                        </div>
                        <div class="p-2">
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            @if($userCoinTransfers->count() > 0)
                                                @foreach($userCoinTransfers as $userCoinTransfer)
                                                    <tr>
                                                        ...
                                                        <td scope="row">
                                                            <a class="btn btn-dark" href="{{ route("shortcut_user",['username'=>$userCoinTransfer->fromUser]) }}">{{ $userCoinTransfer->fromUser }}</a>
                                                        </td>
