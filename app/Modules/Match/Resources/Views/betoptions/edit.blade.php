                ...
                <div class="panel panel-bordered panel-info border border-info">
                    ...
                    <div class="p-2">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-5">
                                    <form action="{{ route('betoptions_update',['id'=> $betoption->id]) }}" method="POST"  id="exampleFullForm" autocomplete="off">
                                        @csrf
                                                        ...
                                                        <select class="form-control" id="sport_id" name="sport_id"
                                                            ...
                                                            @if($sports)
                                                                @foreach ($sports as $sport)
                                                                    <option value="{{ $sport->id}}" @if($sport->id == $betoption->sport_id) selected="selected" @endif>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-icon">
                                                        ...
                                                        <input type="text" class="form-control" name="betOptionName"
                                                            placeholder="Bet Options title" required="" value="{{ $betoption->betOptionName}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-lg">
                                            <div class="form-group col-xl-2 padding-top-m">
                                                <button type="submit" class="btn btn-info" id="validateButton1">Update Bet Options</button>
                                            </div>
                                        </div>
