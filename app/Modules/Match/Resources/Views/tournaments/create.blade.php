...
@section('page_title', 'Tournament create')
                ...
                <div class="panel panel-bordered panel-info border border-info">
                    ...
                    <div class="p-2">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-5">
                                    <form action="{{ route('tournaments_store') }}" method="POST" id="exampleFullForm"
                                        autocomplete="off">
                                        @csrf
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-icon">
                                                        ...
                                                        <input type="text" class="form-control" name="tournamentName"
                                                            placeholder="Tournament Name"  autofocus>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-icon">
                                                        ...
                                                        <select class="form-control" id="sport_id" name="sport_id"
                                                            ...
                                                            <option value="{{ $sport->id}}">{{ ucfirst($sport->sportName)}}
                                                            </option>
                                                            @endforeach
                                                            @endif
                                                        </select>
