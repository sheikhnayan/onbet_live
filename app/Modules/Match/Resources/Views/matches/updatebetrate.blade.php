                    ...
                    <div class="panel panel-bordered panel-dark border border-dark" style="background: #000">
                        <div class="panel-heading-custom" style="background:#343a40 ">
                            <h3 class="panel-title-custom"><span class="liveNotification"><b class="liveDot"></b>Live Room</span> 
                                 @if($match->sport_id == 1 && $match->status == 3 && $match->questionStatusSecond == 0)
                                    <a onclick="return confirm('Are you sure create 2nd innings question?')" style="float: right;margin-right:10px;" class="btn btn-xs btn-success" href="{{ route('single_match_group_question_second',['id'=>$match->id])}}"> <i class="fa fa-question" aria-hidden="true"></i> 2nd innings </a>
                                @endif
                        ...
                        <div class="p-5">
                            <div class="nav-tabs-horizontal" data-plugin="tabs">
                                <ul class="nav nav-tabs nav-tabs-line tabs-line-top" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation"><a class="nav-link active show" data-toggle="tab" href="#currentBetNew" aria-controls="currentBetNew" role="tab" aria-selected="false">Without Page Loading</a></li>
                                    ...
                                    <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#betSingleOffOnHideOpen" aria-controls="betSingleOffOnHideOpen" role="tab" aria-selected="false">Bet Single Off On Hide Open </a></li>
                                ...
                                <div class="tab-content pt-20">
                                                                            ...
                                                                            @foreach($optionBetDetail['betDetails'] as $key=>$betDetailItem)
                                                                                ...
                                                                                <div class="row p-2">
                                                                                    <div class="form-group col-md-6">
                                                                                        <input style="color:#000;font-size:22px;" type="text" class="form-control form-control-sm" id="{{ $betDetailItem->id }}" name="betNameEdit" placeholder="bet name" @if($match->status != 0) readonly @endif value="{{ ucfirst($betDetailItem->betName)}}">
                                                                                    </div>
                                                                                    <div class="form-group col-md-6">
                                                                                        <input style="color:#000;font-size:22px;" type="text" class="form-control form-control-sm font-weight-bold" name="betRateEdit[]" placeholder="rate%" value="{{ $betDetailItem->betRate }}">
                                                                                    </div>
                                                                                </div>
                                                                            @endforeach
                                    ...
                                    <div class="tab-pane active show" id="currentBetNew" role="tabpanel">
                                        <div class="panel-group" id="AccordionDefault" aria-multiselectable="true" role="tablist">
                                            <div class="row">
                                                @if($optionBetDetails)
                                                    @foreach($optionBetDetails as $key=>$optionBetDetail)
                                                        <div class="col-md-3 col-sm-6 mb-2">
                                                            <div class="panel panel-dark border border-dark"  style="background: #333;">
                                                                ...
                                                                <div class="panel-collapse collapse" id="accordionDefaultId{{ $key }}" aria-labelledby="accordionId{{ $key }}" role="tabpanel">
                                                                    @if($optionBetDetail['betDetails'])
                                                                        <form method="GET" id="livebetratevalue">
                                                                            @csrf
                                                                            @foreach($optionBetDetail['betDetails'] as $key=>$betDetailItem)
                                                                                <input type="hidden" value="{{ $betDetailItem->betoption_id }}" name="betoptionId"/>
                                                                                <input type="hidden" value="{{ $betDetailItem->id }}" name="id[]"/>
                                                                                <div class="row p-2">
                                                                                    ...
                                                                                    <div class="form-group col-md-6">
                                                                                        <input style="color:#000;font-size:22px;" type="text" class="form-control form-control-sm font-weight-bold" name="betRateEdit[]" placeholder="rate%" value="{{ $betDetailItem->betRate }}" autocomplete="off">
                                                                                    </div>
                                                                                </div>
                                                                            @endforeach
                                                                        </form>
                                                                        <input type="submit" id="" class="btn btn-block btn-secondary livebetrateupdate" value="Update"/>
                                                                        <p class="text-center text-warning loading" style="display:none">Processing.....</p>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3 form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group input-group-icon">
                                                                    ...
                                                                    <select class="form-control" id="fullMatchStatus">
                                    ...
                                    <div class="tab-pane" id="betSingleOffOnHideOpen" role="tabpanel" >
                                        <div class="panel-group" id="AccordionDefault" aria-multiselectable="true" role="tablist">
                                            <div class="row">
                                                @if($optionBetDetails)
                                                    @foreach($optionBetDetails as $key=>$optionBetDetail)
                                                        ...
                                                        @if($score->match->sport_id == 1)
                                                            <div class="form-group">
                                                                <div class="input-group input-group-icon">
                                                                    ...
                                                                    <input type="text" class="form-control" id="overs" value="@if($score->overs){{ $score->overs }}@endif">
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <div class="form-group">
                                                            <div class="input-group input-group-icon">
                                                                ...
                                                                <textarea class="form-control" id="score" >@if($score->score) {{ $score->score}}@endif</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('page_scripts')
    ...
    <script type="text/javascript">
        ...
        //serialize
        $(document).on("click",".livebetrateupdate", function (e) {
            e.preventDefault();
            $(".livebetrateupdate").css("display", "none");
            $(".loading").css("display", "block");
            $.ajax({
                type:'get',
                url: '/admin/matches/total/question/bet/rate/update/new/ajax',
                data: $(this).prev("form").serialize(),
                success:function(response){
                    $(".livebetrateupdate").css("display", "block");
