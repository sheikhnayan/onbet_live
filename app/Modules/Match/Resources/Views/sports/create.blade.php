...
@section('title', 'Sports Create')
@section('page_title', 'Sports create')
                ...
                <div class="panel panel-bordered panel-info border border-info">
                    ...
                    <div class="p-2">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-5">
                                    <form action="{{ route('sport_store') }}" method="POST" id="exampleFullForm"
                                        autocomplete="off">
                                        @csrf
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-icon">
                                                        ...
                                                        <input type="text" class="form-control" name="sportName"
                                                            placeholder="Sports Name" required="" autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
