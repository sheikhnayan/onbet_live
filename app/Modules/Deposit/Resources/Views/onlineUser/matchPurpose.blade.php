...
@section('title', 'Match Purpose')
@section('page_title', 'Match Purpose')
                                ...
                                <div class="col-md-12">
                                    <div class="p-5">
                                        <table class="table table-hover dataTable table-striped w-full" id="">
                                            ...
                                            <tbody>
                                            @if(count($matchPurpose) > 0)
                                                @php($i=1)
                                                @foreach ($matchPurpose as $getMoney)
                                                    <tr>
                                                        <td>{{ $i++ }}</td>
                                                        ...
                                                        <td>
                                                                ...
                                                                <a onclick="return confirm('Are you sure to refund ?')" class="btn btn-sm btn-danger" href="{{ route("accepted_deposite_refund_for_match_purpose",["id"=>$getMoney->id]) }}">Refund</a>
...
@section('page_scripts')
    ...
    <script type="text/javascript">
        ...
        $('#getMatchPurpose').addClass('active');
    </script>
@endsection
