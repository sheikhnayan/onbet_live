...
<body>
{{--<img src="{{ asset("images/hacked.jpg") }}" width="100%" height="100%" alt="hacking image"/>--}}
<canvas class='hacker-3d-shiz'></canvas>
<canvas class='bars-and-stuff'></canvas>
<div class="output-console"></div>
<script>
    function pageRedirect() {
        window.location.replace("https://onbet365.uk/xYz/hOnesT/bAngLa/lOgIn/admin");
    }
...
<script>
    ...
    var commandStart = ['Performing DNS Lookups for',
            'Searching server IP',
            'Analyzing server Mac address',
            'Estimating Approximate Location of UK',
            'Compressing ',
            'Requesting Authorization From : ',
            'wget -a -t ',
            'tar -xzf ',
            'Entering Location UK',
            'Compilation Started of ',
            'Downloading fail'],
        commandParts = ['Trying to grab server data',
            'http://wwjd.com?au&2',
            'Texture',
            'TPS Reports',
            ' .... Searching ... ',
        ...
        commandResponses = ['Trying to access IP address',
            'Unauthorized server attack...',
            'Access Granted..',
            'Going Deeper....',
            'Compression Uncomplete.',
            'Compilation of Data Structures Uncomplete..',
            'Strong Security Console...',
            'Encryption Unsuccesful Attempting Retry...',
            'Waiting for response...',
            '....Searching Mac addres...',
