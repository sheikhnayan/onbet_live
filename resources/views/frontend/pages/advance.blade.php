                                                                ...
                                                                @foreach($match["matchOption"] as $matchesOption)
                                                                    ...
                                                                    <div class="choice-team-part">
                                                                        @foreach($matchesOption["betDetails"] as $betDetail)
                                                                            <button value="{{ $betDetail->id }}" class="single-item-for-mobile clickSingleBetDetail" data-target="#placeBetBtn" data-toggle="modal" data-backdrop="static" data-keyboard="false">
