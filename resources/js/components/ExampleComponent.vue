                    ...
                    <div  v-for="(match, key) in sportItems">
                        <div class="matchTournamentLiveWrap">
                            <div class="matchTournamentDetailPart">
                                <p>
                                    ...
                                    <span class="badge badge-success">{{ match["matchDateTime"] | dateformat}}</span>
                                    <span class="badge badge-primary"> {{ match["matchDateTime"] | timeformat}}</span>
                                </p>
                                <p>
                                    {{ match["matchTitle"] }}
                                </p>
                        ...
                        <div v-for="(matchesOption, key) in match['matchOption']">
                            ...
                            <div class="choice-team-part">
                                <button v-for="(betDetail, key) in matchesOption['betDetails']" @click="clickSingleBetDetail(betDetail,matchesOption['matchOption'])" class="single-item-for-mobile clickSingleBetDetail" data-target="#placeBetBtn" data-toggle="modal" data-backdrop="" data-keyboard="false">
                                <span >&nbsp;{{ betDetail['betName'] | capitalizeFirstLetter }}
                                    <b class="text-danger" v-if="betDetail['status'] == 0"> x</b>
                ...
                <div class="sports_single_category">
                    ...
                    <div v-for="(match, key) in matches[0]">
                        ...
                        <div v-for="(matchesOption, key) in match['matchOption']">
                            ...
                            <div class="choice-team-part">
                                <button v-for="(betDetail, key) in matchesOption['betDetails']" @click="clickSingleBetDetail(betDetail,matchesOption['matchOption'])" value="" class="single-item-for-mobile clickSingleBetDetail" data-target="#placeBetBtn" data-toggle="modal" data-backdrop="" data-keyboard="false">
                                    <span >{{ betDetail['betName'] | capitalizeFirstLetter }}&nbsp;
                                    <b class="text-danger" v-if="betDetail['status'] == 0"> x</b>
                                    <b class="text-primary" v-else-if="betDetail['status'] == 1"> {{ betDetail['betRate'] }}</b>
                                </span>
