      ...
      (0, _jquery.default)('#exampleFullForm').formValidation({
        ...
        fields: {
          matchTitle: {
            validators: {
              notEmpty: {
                message: 'Match title is required'
              }
            }
          },
          sport_id: {
            validators: {
              notEmpty: {
                message: 'Please specify one sports category'
              }
            }
          },
          tournament_id: {
            validators: {
              notEmpty: {
                message: 'Please specify one tournament'
              }
            }
          },
          teamOne_id: {
            validators: {
              notEmpty: {
                message: 'Please specify first team'
              }
            }
          },
          teamTwo_id: {
            validators: {
              notEmpty: {
                message: 'Please specify second team'
              }
            }
          },
          matchDate: {
          ...
          matchTime: {
            ...
            matchDateTime: {
              validators: {
                notEmpty: {
                  message: 'Match Date time is required'
                },
              }
            },
        },
